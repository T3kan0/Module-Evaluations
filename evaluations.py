...
'+str(camp[0][0])+', in the '+str(Prog[0][0])+' programme. They speak '+str(Lang[0])+' languages, and came in '+str(gend[0])+' various genders.')
        ...
        pdf.cell(50, 10, "Questions", border=1, align="C")
        pdf.cell(30, 10, "Weighted Outcome", border=1, align="C")
        ...
        for q, outcome_tuple in zip(qual_questions, tutorial_organisation_outcome):
            ...
            pdf.cell(50, 10, q, border=1, align="C")
            pdf.cell(30, 10, str(outcome_label), border=1, align="C")
