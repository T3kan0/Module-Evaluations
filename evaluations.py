...
################### Online vanue ############
        ...
        # --- Create wordclouds for each theme ---
        fig, axes = plt.subplots(1, 2, figsize=(14, 6))
        for i, topic in enumerate(H):  # H has shape (n_components, n_features)
            # word: weight dict
            ...
            axes[i].axis("off")
            axes[i].set_title(f"Theme {i+1}", fontsize=14)
        plt.tight_layout()
        plt.savefig('word_count3.png')
...
'+str(camp[0][0])+', in the '+str(Prog[0][0])+' programme. They speak '+str(Lang[0])+' languages, and came in '+str(gend[0])+' various genders.')
        ...
        pdf.cell(0, 5, txt = '3.1. Evaluation Outcomes', ln =14, align = 'L')
        pdf.cell(0, 5, txt = '', ln =15, align = 'C')
        pdf.set_font('Arial','B',10.0)
        ...
        #pdf.cell(0, 5, txt = '', ln =19, align = 'C')
        #s39 = 'interct1.png'
        #pdf.image(str(s39), x = 50, y = 20, w = 100, h = 70, type = 'PNG')
        #pdf.ln(0.25)
        #pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        #pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        #pdf.cell(0, 5, txt = '', ln =19, align = 'C')   
        ...
        #s42 = 'conducive2.png'
        #pdf.image(str(s42), x = 50, y = 20, w = 100, h = 70, type = 'PNG')
        #pdf.ln(0.25)
        #pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        #pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        #pdf.cell(0, 5, txt = '', ln =19, align = 'C')   
        ...
        #pdf.cell(0, 5, txt = '', ln =19, align = 'C')
        #s43 = 'inter2.png'
        #pdf.image(str(s43), x = 50, y = 100, w = 100, h = 70, type = 'PNG')
        #pdf.ln(0.25)
        #pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        #pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        #pdf.cell(0, 5, txt = '', ln =19, align = 'C')   
