...
'+str(camp[0][0])+', in the '+str(Prog[0][0])+' programme. They speak '+str(Lang[0])+' languages, and came in '+str(gend[0])+' various genders.')
        ...
        pdf.ln(0.25)
        s16 = 'improve.png'
        pdf.image(str(s16), x = 50, y = 30, w = 100, h = 70, type = 'PNG')
        pdf.ln(0.25)
        pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        pdf.cell(0, 5, txt = '', ln =19, align = 'C')   
        ...
        pdf.cell(80, 10, "Response", border=1, align="C")
        pdf.cell(60, 10, "Count (%)", border=1, align="C")
        pdf.ln()

        pdf.set_font("Arial", size=10)
        for response, percent in tutorial_qual_distribution.items():
            pdf.cell(80, 10, response, border=1)
            pdf.cell(60, 10, f"{percent}%", border=1, align="C")
            pdf.ln()
        ...
        pdf.cell(0, 5, txt = '', ln =19, align = 'C') 
        s25 = 'efft.png'
        pdf.image(str(s25), x = 50, y = 20, w = 100, h = 70, type = 'PNG')
        pdf.ln(0.25)
        pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        pdf.cell(0, 5, txt = '', ln =19, align = 'C')   
        ...
        pdf.ln(0.25)
        s26 = 'conf.png'
        pdf.image(str(s26), x = 50, y = 100, w = 100, h = 70, type = 'PNG')
        pdf.ln(0.25)
        pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        pdf.cell(0, 5, txt = '', ln =20, align = 'C')
        pdf.cell(0, 5, txt = '', ln =19, align = 'C')   
